...
function ByggUppXML(thisForm)
{
	...
	Ext.Ajax.request(
	{
		url: 'https://www.sg-systemet.com/bestallning/Gettime.php',
...
function SkapaOrdernummer(timestamp)
{
	...
	Ext.Ajax.request(
	{
		url: 'https://www.sg-systemet.com/bestallning/CreateOrdernumber.php',
...
function BackupOrder(ordernummer, time, xml, text, formular)
{
	Ext.Ajax.request(
	{
		url: 'https://www.sg-systemet.com/bestallning/BackupOrder.php',
...
function SkickaEpost(ordernummer, xml, text, formular)
{
	...
	Ext.Ajax.request(
	{
		url: 'https://www.sg-systemet.com/bestallning/Bestallningsformular.php',
...
function KontrolleraFormular(thisForm)
{
	...
	// Kontrollerar Faktureringsadress
	if (formular.FAdress.value == '')
	{
		if (!FormularOk)
		{
			Felmeddelande += '\n';
		}
		Felmeddelande += 'Måste fylla i faktureringsadress. ';
		FormularOk = false;
	}
	
	// Kontrollerar Organisationsnummer
	if (formular.VAT.value == '')
	{
		if (!FormularOk)
		{
			Felmeddelande += '\n';
		}
		Felmeddelande += 'Måste fylla i organisationsnummer. ';
		FormularOk = false;
	}
	...
	// Kontrollerar Beställningsreferens
	if (formular.Bestallningsreferens.value == '')
	{
		if (!FormularOk)
		{
			Felmeddelande += '\n';
		}
		Felmeddelande += 'Måste fylla i Beställningsreferens. ';
		FormularOk = false;
	}
